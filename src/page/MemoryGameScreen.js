import { StyleSheet, Text, View, Dimensions, PixelRatio, TouchableHighlight, ProgressBarAndroid, Platform, StatusBar } from 'react-native';
...
class MemoryGameScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      page: 'start',
